...
String sid_0,sid_1,sid_2,sid_3,sid_4,sid_5,cid_0,cid_1,cid_2,cid_3,cid_4,cid_5,hid_0,hid_1,hid_2,hid_3,hid_4,hid_5;
    ...
    new File("C:\\Users\\maitr\\Desktop\\fire alarm ppt\\Fire-Alarm-System-master (5)\\Fire-Alarm-System-master (5)\\Fire-Alarm-System-master\\src\\main\\java\\com\\mycompany\\fire_alarm_system\\log.txt"), 
    true /* append = true */)); 
    ...
    public class colorcode extends DefaultTableCellRenderer {
        ...
        public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected, boolean hasFocus, int row, int col) {
            ...
            if(flagmail == 2)
            {
                flagmail++;
                try {
                Mail.sendEmail("iit2019096@iiita.ac.in");
            } catch (Exception ex) {
